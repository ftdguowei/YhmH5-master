...
import com.sigmatrix.yhmh5.yhmh5.camera.CameraManager;
import com.sigmatrix.yhmh5.yhmh5.decoding.CaptureActivityHandler;
import com.sigmatrix.yhmh5.yhmh5.decoding.InactivityTimer;
import com.sigmatrix.yhmh5.yhmh5.decoding.RGBLuminanceSource;
import com.sigmatrix.yhmh5.yhmh5.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback ,View.OnClickListener{
	...
	private RelativeLayout rel_progressbar;
	private int tep = -1;//1是旧码 2是新码
	 ...
	 * 注册事件
	 */
	private void setListenerandView() {
		boolean b = isCameraPermission();
		if(!b){
			Toast.makeText(CaptureActivity.this,"相机权限被拒绝，请前往安全中心设置",Toast.LENGTH_SHORT).show();
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(CaptureActivity.this,"码不正确",Toast.LENGTH_SHORT);
			return;
		}
